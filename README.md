...
### Статистический анализ оценок судей
...
Из-за того, что разные судьи оценивают разные игры, то и средняя оценка у игры от судей получается разная. Более строгий судья обычно занижет оценки, а более добрый завышает. Какой-то игре может повезти, и её оценят **только** "добрые" судьи, а какой-то не повезти -- и будут **только** суровые оценки.

Поэтому для корректного сравнения игр при разделении игр между судьями между собой нужно учитывать "строгость" судей. Сравнивать средние оценки игр между собой некорректно, так как они зависят от "строгости" судей!
